...
setuptools.setup(
    ...
    version="1.0.18",  # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="byte",  # 作者名字
    ...
    url="https://github.com/zerobyte1o1/gensp",
    ...
    install_requires=['psycopg2-binary==2.9.6', 'PyYAML==6.0'],  # 依赖的包
    entry_points={
        'console_scripts': [
